...
// ==================== NETWORK CONFIG ====================
const char* ssid = "levion-DHP";
const char* password = "1234567890dhp";
...
void reconnect_mqtt() {
  ...
  if (!client.connected() && (millis() - lastMQTTRetry >= mqttRetryInterval)) {
    ...
    String clientId = "ESP32_Tank" + String(TANK_NUMBER) + "CO2";
